...
let joe1 = student('Joe1', 'Schmoe', 100);
...
// console.log(greeting(joe1.name));


//Student.prototype.greeting = () => `Hi, may name is ${joe.name}`;
...
// When using arrow functions you are no longer able to use the keyword this.
...
// this returned the object joe on line 207 but line 211 returned undefined for me
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// this returned the window object on line 213 but undefined was returned on line 216
// 3. Explain why "this" is different when an arrow function is used.
// When the arrow function is used the scope of the function bubbles up to the next nearest scope or in this case the scope becomes the global window object.
